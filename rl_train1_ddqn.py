...
# ---------------------------
# SAVE OUTPUTS (CORRECT NAMES)
# ---------------------------
torch.save(policy_net.state_dict(), MODEL_DIR / "ddqn_pricing_model.pt")
np.save(MODEL_DIR / "ddqn_rewards.npy", reward_history)

print("✅ DDQN training complete. Model and rewards saved.")
